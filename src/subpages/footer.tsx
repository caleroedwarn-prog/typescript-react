      ...
      <>
        <div className="Footer">
          ...
          <span className="Contact">
            ...
            <p>
              ToDo Prior is committed to protecting your privacy. Please review
              our <a href="https://www.example.com/privacy">Privacy Policy</a>{" "}
              for more information.
            </p>
          </span>
          <span className="marker">
            <p>
              © 2024 ToDo Prior. All rights reserved.{" "}
              <h4 style={{ color: "green" }}> Vector Crew VCX2</h4>
            </p>
          </span>
        </div>
      </>
